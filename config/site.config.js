...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'jie@xiameilan.onmicrosoft.com',
  ...
  email: 'mailto:zhoujie218@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/vbskycn/onedrive-vercel-index',
    },
  ],
